...
=======
    ...
    def capacities_and_potentials_dataframe(self):
        ...
        if self._capacities_and_potentials_dataframe is not None:
            ...
            self._capacities_and_potentials_dataframe = self.print_capacities_and_potentials()
            return self._capacities_and_potentials_dataframe    
    ...
    def initialize(self):
        ...
        pava = self.parameter_values
        if pava.get("Separator dry density [kg.m-3]") is not None:
                    pava["Separator density [kg.m-3]"] = pava.get("Separator porosity") * pava.get("Electrolyte density [kg.m-3]",0) + pava.get("Separator dry density [kg.m-3]",0)
        if pava.get("Separator material density [kg.m-3]") is not None:
                    pava["Separator density [kg.m-3]"] = pava.get("Separator porosity") * pava.get("Electrolyte density [kg.m-3]",0) + (1 - pava.get("Separator porosity")) * pava.get("Separator material density [kg.m-3]",0)
        electrodes = ["Negative electrode", "Positive electrode"]
        for electrode in electrodes:
            if (pava.get(f"{electrode} active material volume fraction", 0) + pava.get(f"{electrode} porosity", 0) == 1) and pava.get(f"{electrode} binder dry mass fraction") is None and pava.get(f"{electrode} conductive additive dry mass fraction") is None and pava.get(f"{electrode} active material dry mass fraction") is None:
                pava[f"{electrode} dry density [kg.m-3]"] = pava.get(f"{electrode} density [kg.m-3]") - pava.get(f"{electrode} porosity") * pava.get("Electrolyte density [kg.m-3]",0)
                pava[f"{electrode} active material density [kg.m-3]"] = pava.get(f"{electrode} dry density [kg.m-3]")
                print (f"Warning: '{electrode} active material density [kg.m-3]' and '{electrode} dry density [kg.m-3]' have been calulated from;'Electrolyte density [kg.m-3]', '{electrode} porosity' and '{electrode} density [kg.m-3]'")
            if (pava.get(f"{electrode} binder dry mass fraction") is not None and
                pava.get(f"{electrode} conductive additive dry mass fraction") is not None and
                pava.get(f"{electrode} binder density [kg.m-3]") is not None and
                pava.get(f"{electrode} conductive additive density [kg.m-3]") is not None):
                pava[f"{electrode} active material dry mass fraction"] = 1 - pava.get(f"{electrode} binder dry mass fraction") - pava.get(f"{electrode} conductive additive dry mass fraction")
                pava[f"{electrode} inactive material density [kg.m-3]"] = (pava.get(f"{electrode} binder dry mass fraction") + pava.get(f"{electrode} conductive additive dry mass fraction")) / (pava.get(f"{electrode} binder dry mass fraction") / pava.get(f"{electrode} binder density [kg.m-3]") + pava.get(f"{electrode} conductive additive dry mass fraction") / pava.get(f"{electrode} conductive additive density [kg.m-3]"))
            if (pava.get(f"{electrode} active material dry mass fraction") is not None and
                pava.get(f"{electrode} active material density [kg.m-3]") is not None and
                pava.get(f"{electrode} inactive material density [kg.m-3]") is not None):
                pava[f"{electrode} active material volume fraction"] = (1 - pava.get(f"{electrode} porosity")) * (pava.get(f"{electrode} active material dry mass fraction") / pava.get(f"{electrode} active material density [kg.m-3]") / (pava.get(f"{electrode} active material dry mass fraction") / pava.get(f"{electrode} active material density [kg.m-3]") + (1 - pava.get(f"{electrode} active material dry mass fraction")) / pava.get(f"{electrode} inactive material density [kg.m-3]")))
                pava[f"{electrode} dry density [kg.m-3]"] = pava.get(f"{electrode} active material volume fraction") * pava.get(f"{electrode} active material density [kg.m-3]") + (1 - pava.get(f"{electrode} active material volume fraction") - pava.get(f"{electrode} porosity"))*pava.get(f"{electrode} inactive material density [kg.m-3]")
                pava[f"{electrode} density [kg.m-3]"] = pava.get(f"{electrode} dry density [kg.m-3]") + pava.get(f"{electrode} porosity") * pava.get("Electrolyte density [kg.m-3]")
            if (pava.get(f"{electrode} active material capacity [mA.h.g-1]") is not None and
                pava.get(f"{electrode} active material density [kg.m-3]") is not None):
                if electrode == "Negative electrode":
                    pava["Maximum concentration in negative electrode [mol.m-3]"] = pava.get(f"{electrode} active material capacity [mA.h.g-1]") * pava.get(f"{electrode} active material density [kg.m-3]") * 3600 / 96485
                elif electrode == "Positive electrode":
                    pava["Maximum concentration in positive electrode [mol.m-3]"] = pava.get(f"{electrode} active material capacity [mA.h.g-1]") * pava.get(f"{electrode} active material density [kg.m-3]") * 3600 / 96485
            else:
                if electrode == "Negative electrode" and pava.get(f"{electrode} active material density [kg.m-3]") is not None:
                    pava[f"{electrode} active material capacity [mA.h.g-1]"] = pava.get("Maximum concentration in negative electrode [mol.m-3]") / pava.get(f"{electrode} active material density [kg.m-3]") * 96485 / 3600
                elif electrode == "Positive electrode" and pava.get(f"{electrode} active material density [kg.m-3]") is not None:
                    pava[f"{electrode} active material capacity [mA.h.g-1]"] = pava.get("Maximum concentration in positive electrode [mol.m-3]") / pava.get(f"{electrode} active material density [kg.m-3]") * 96485 / 3600            
        if (pava.get("Theoretical n/p ratio") is not None and pava.get("Negative electrode thickness [m]") is not None and pava.get("Positive electrode thickness [m]") is not None) or (pava.get("Theoretical n/p ratio") is not None and pava.get("Negative electrode thickness [m]") is None and pava.get("Positive electrode thickness [m]") is not None):
            pava["Negative electrode thickness [m]"] = pava.get("Theoretical n/p ratio") * pava.get("Positive electrode thickness [m]") * pava.get("Positive electrode active material volume fraction") * pava.get("Maximum concentration in positive electrode [mol.m-3]") / (pava.get("Negative electrode active material volume fraction") * pava.get("Maximum concentration in negative electrode [mol.m-3]"))
        ...
        if (pava.get("Theoretical n/p ratio") is not None and pava.get("Negative electrode thickness [m]") is not None and pava.get("Positive electrode thickness [m]") is None):
            pava["Positive electrode thickness [m]"] = (pava.get("Negative electrode thickness [m]") * pava.get("Negative electrode active material volume fraction") * pava.get("Maximum concentration in negative electrode [mol.m-3]")) / (pava.get("Theoretical n/p ratio") * pava.get("Positive electrode active material volume fraction") * pava.get("Maximum concentration in positive electrode [mol.m-3]"))
            warnings.warn("Warning: 'Negative electrode thickness [m]' has been calculated from 'Theoretical n/p ratio' and 'Positive electrode thickness [m]'")
        if pava.get("Negative electrode thickness [m]") is not None and pava.get("Positive electrode thickness [m]") is not None:
            pava["Theoretical n/p ratio"] = pava.get("Negative electrode thickness [m]") * pava.get("Negative electrode active material volume fraction") * pava.get("Maximum concentration in negative electrode [mol.m-3]") / (pava.get("Positive electrode thickness [m]") * pava.get("Positive electrode active material volume fraction") * pava.get("Maximum concentration in positive electrode [mol.m-3]"))
...
>>>>>>> Stashed changes
    ...
    def print_stack_energy_densities(self):
        ...
        data = [
            {"Parameter": "Volumetric energy density", "Unit": "Wh.L-1", "Value": stack_ed.get("Volumetric stack energy density [Wh.L-1]")},
            {"Parameter": "Gravimetric energy density", "Unit": "Wh.kg-1", "Value": stack_ed.get("Gravimetric stack energy density [Wh.kg-1]")},
            {"Parameter": "Stack average OCP", "Unit": "V", "Value": stack_ed.get("Stack average OCP [V]")},
            {"Parameter": "Capacity", "Unit": "mA.h.cm-2", "Value": stack_ed.get("Capacity [mA.h.cm-2]")},
            {"Parameter": "(Single-) stack thickness", "Unit": "um", "Value": 10**6 * stack_ed.get("Stack thickness [m]")},
            {"Parameter": "Stack density", "Unit": "kg.L-1", "Value": 10**-3 * stack_ed.get("Stack density [kg.m-3]")},
        ]
    ...
    def print_capacities_and_potentials(self):
        ...
        data = [
            ...
            {"Parameter": "Stack average OCP", "Unit": "V", "Value": stack_ed.get("Stack average OCP [V]")},
            {"Parameter": "Maximal OCP", "Unit": "V", "Value": stack_ed.get("Maximal OCP [V]")},
            {"Parameter": "Minimal OCP", "Unit": "V", "Value": stack_ed.get("Minimal OCP [V]")},
            # electrode potentials
            {"Parameter": "Electrode potentials", "Unit": "", "Value": ""},
            {"Parameter": "Negative electrode average OCP", "Unit": "V", "Value": stack_ed.get("Negative electrode average OCP [V]")},
            {"Parameter": "Positive electrode average OCP", "Unit": "V", "Value": stack_ed.get("Positive electrode average OCP [V]")},
            # n/p ratio
            {"Parameter": "n/p ratio's", "Unit": "", "Value": ""},
            {"Parameter": "Practical n/p ratio", "Unit": "-", "Value": stack_ed.get("Practical n/p ratio")},
            {"Parameter": "Theoretical n/p ratio", "Unit": "-", "Value": self.parameter_values.get("Theoretical n/p ratio")},
            # stack capacities
            {"Parameter": "Stack capacities", "Unit": "", "Value": ""},
            {"Parameter": "Volumetric stack capacity", "Unit": "Ah.L-1", "Value": stack_ed.get("Volumetric stack capacity [Ah.L-1]")},
            {"Parameter": "Gravimetric stack capacity", "Unit": "Ah.kg-1", "Value": stack_ed.get("Gravimetric stack capacity [Ah.kg-1]")},
            {"Parameter": "Capacity", "Unit": "mA.h.cm-2", "Value": stack_ed.get("Capacity [mA.h.cm-2]")},
            # electrode capacities
            {"Parameter": "Electrode capacities", "Unit": "", "Value": ""},
            {"Parameter": "Negative electrode theoretical capacity", "Unit": "mA.h.cm-2", "Value": stack_ed.get("Negative electrode theoretical capacity [mA.h.cm-2]")},
            {"Parameter": "Positive electrode theoretical capacity", "Unit": "mA.h.cm-2", "Value": stack_ed.get("Positive electrode theoretical capacity [mA.h.cm-2]")},
            {"Parameter": "Negative electrode volumetric capacity", "Unit": "mA.h.cm-3", "Value": stack_ed.get("Negative electrode volumetric capacity [mA.h.cm-3]")},
            {"Parameter": "Positive electrode volumetric capacity", "Unit": "mA.h.cm-3", "Value": stack_ed.get("Positive electrode volumetric capacity [mA.h.cm-3]")},
            {"Parameter": "Negative electrode gravimetric capacity", "Unit": "mA.h.g-1", "Value": stack_ed.get("Negative electrode gravimetric capacity [mA.h.g-1]")},
            {"Parameter": "Positive electrode gravimetric capacity", "Unit": "mA.h.g-1", "Value": stack_ed.get("Positive electrode gravimetric capacity [mA.h.g-1]")},
            # active material capacities
            {"Parameter": "Active material capacities", "Unit": "", "Value": ""},
            {"Parameter": "Negative electrode active material practical capacity", "Unit": "mA.h.g-1", "Value": stack_ed.get("Negative electrode active material practical capacity [mA.h.g-1]")},
            {"Parameter": "Positive electrode active material practical capacity", "Unit": "mA.h.g-1", "Value": stack_ed.get("Positive electrode active material practical capacity [mA.h.g-1]")},
            {"Parameter": "Negative electrode active material theoretical capacity", "Unit": "mA.h.g-1", "Value": self.parameter_values.get("Negative electrode active material capacity [mA.h.g-1]")},
            {"Parameter": "Positive electrode active material theoretical capacity", "Unit": "mA.h.g-1", "Value": self.parameter_values.get("Positive electrode active material capacity [mA.h.g-1]")},
            # stoichiometries
            {"Parameter": "Stoichiometries", "Unit": "", "Value": ""},
            {"Parameter": "Negative electrode stoichiometry at 0% SoC", "Unit": "-", "Value": stack_ed.get("Negative electrode stoichiometry at 0% SoC")},
            {"Parameter": "Negative electrode stoichiometry at 100% SoC", "Unit": "-", "Value": stack_ed.get("Negative electrode stoichiometry at 100% SoC")},
            {"Parameter": "Positive electrode stoichiometry at 100% SoC", "Unit": "-", "Value": stack_ed.get("Positive electrode stoichiometry at 100% SoC")},
            {"Parameter": "Positive electrode stoichiometry at 0% SoC", "Unit": "-", "Value": stack_ed.get("Positive electrode stoichiometry at 0% SoC")},
        ]
        # Create the DataFrame from the list of dictionaries
        df = pd.DataFrame(data)
        return df
...
=======
        ...
        if (pava.get("Negative electrode stoichiometry at 0%") is not None 
            ...
            and pava.get("Positive electrode stoichiometry at 0%") is not None) or \
           (pava.get("Negative electrode stoichiometry at 0%") is None 
        ...
        elif (pava.get("Negative electrode stoichiometry at 0%") is not None 
            and pava.get("Negative electrode stoichiometry at 100%") is not None 
            ...
            # update cut-off voltages if voltage curve(s) are provided
        elif (pava.get("Negative electrode OCP [V]") is not None and
            pava.get("Positive electrode OCP [V]") is not None and
            pava.get("Lower voltage cut-off [V]") is not None and
            pava.get("Upper voltage cut-off [V]") is not None):
            x0, x100, y100, y0 = pybamm.lithium_ion.get_min_max_stoichiometries(pybamm.ParameterValues(pava)) # stoichiometries at 0 and 100% SOC based on cell potential limits
        else:
        ...
        for electrode, electrode_ in zip(electrodes, electrodes_):
            stack_ed[f"{electrode} volumetric capacity [mA.h.cm-3]"] = (pava.get(f"Maximum concentration in {electrode_} [mol.m-3]") * 96485 / 3.6 / 1000000 * # C.mol-1 / mA.h.C-1 / cm-3.m-3
                                                                             pava.get(f"{electrode} active material volume fraction") *
                                                                             (max(stack_ed.get(f"{electrode} stoichiometry at 100% SoC"), stack_ed.get(f"{electrode} stoichiometry at 0% SoC")) -
                                                                              min(stack_ed.get(f"{electrode} stoichiometry at 100% SoC"), stack_ed.get(f"{electrode} stoichiometry at 0% SoC"))))
            stack_ed[f"{electrode} gravimetric capacity [mA.h.g-1]"] = (stack_ed.get(f"{electrode} volumetric capacity [mA.h.cm-3]") / pava.get(f"{electrode} density [kg.m-3]") * 1000) # cm3.L-1
            stack_ed[f"{electrode} active material practical capacity [mA.h.g-1]"] = (stack_ed.get(f"{electrode} volumetric capacity [mA.h.cm-3]") / pava.get(f"{electrode} active material volume fraction") / pava.get(f"{electrode} active material density [kg.m-3]") * 1000) # cm3.L-1
            stack_ed[f"{electrode} capacity [mA.h.cm-2]"] = pava.get(f"{electrode} capacity [mA.h.cm-2]") or (stack_ed.get(f"{electrode} volumetric capacity [mA.h.cm-3]") * pava.get(f"{electrode} thickness [m]") * 100) # cm.m-1
            stack_ed[f"{electrode} theoretical capacity [mA.h.cm-2]"] = pava.get(f"Maximum concentration in {electrode_} [mol.m-3]") * pava.get(f"{electrode} active material volume fraction") * pava.get(f"{electrode} thickness [m]") * 100 * 96485 / 3.6 / 1000000 # cm.m-1 * C.mol-1 / mA.h.C-1 / cm-3.m-3
        stack_ed["Capacity [mA.h.cm-2]"] = min(stack_ed.get("Negative electrode capacity [mA.h.cm-2]"),stack_ed.get("Positive electrode capacity [mA.h.cm-2]"))

        # practical n/p ratio
        stack_ed["Practical n/p ratio"] = (1 - x0) / (y0 - y100) * pava.get("Negative electrode active material volume fraction") * pava.get("Negative electrode thickness [m]") * pava.get("Maximum concentration in negative electrode [mol.m-3]") / (pava.get("Positive electrode active material volume fraction") * pava.get("Positive electrode thickness [m]") * pava.get("Maximum concentration in positive electrode [mol.m-3]"))
        ...
        if pava.get("Negative electrode average OCP [V]") is not None:
            stack_ed["Negative electrode average OCP [V]"] = pava.get("Negative electrode average OCP [V]")
            ne_0 = pava.get("Negative electrode average OCP [V]")
            ne_100 = pava.get("Negative electrode average OCP [V]")
        elif pava.get("Negative electrode OCP [V]") is not None and pava.get("Negative electrode average OCP [V]") is None:
            ne_ocv = pava["Negative electrode OCP [V]"]
            stack_ed["Negative electrode average OCP [V]"] = ne_ocv(x).evaluate().mean()
        ...
        if pava.get("Positive electrode average OCP [V]") is not None:
            stack_ed["Positive electrode average OCP [V]"] = pava.get("Positive electrode average OCP [V]")
            pe_0 = pava.get("Positive electrode average OCP [V]")
            pe_100 = pava.get("Positive electrode average OCP [V]")
        elif pava.get("Positive electrode OCP [V]") is not None and pava.get("Positive electrode average OCP [V]") is None:
            pe_ocv = pava["Positive electrode OCP [V]"]
            stack_ed["Positive electrode average OCP [V]"] = pe_ocv(y).evaluate().mean()
        ...
        if pava.get("Stack average OCP [V]") is not None:
           ...
           stack_ed["Stack average OCP [V]"] = (stack_ed.get("Positive electrode average OCP [V]") - stack_ed.get("Negative electrode average OCP [V]"))
...
=======
            stack_bd[f"{electrode} electrolyte volume fraction"] = pava.get(f"{electrode} porosity")
            stack_bd[f"{electrode} active material volume fraction"] = pava.get(f"{electrode} active material volume fraction")
            stack_bd[f"{electrode} inactive material volume fraction"] = 1 - stack_bd.get(f"{electrode} electrolyte volume fraction") - stack_bd.get(f"{electrode} active material volume fraction")
            stack_bd[f"{electrode} dry volume fraction"] = 1
            stack_bd[f"{electrode} volume fraction"] = 1
        stack_bd["Separator electrolyte volume fraction"] = pava.get("Separator porosity")
        stack_bd["Separator material volume fraction"] = 1 - stack_bd.get("Separator electrolyte volume fraction")
        stack_bd["Separator volume fraction"] = 1
...
=======
            if pava.get(f"{electrode} active material density [kg.m-3]") is None and stack_bd.get(f"{electrode} inactive material volume fraction") != 0:
                warnings.warn(f"Warning: Missing '{electrode} active material density [kg.m-3]'")
        for component in ["Negative electrode", "Positive electrode", "Separator", "Negative current collector", "Positive current collector"]:
            if pava.get(f"{component} density [kg.m-3]") is None:
                warnings.warn(f"Warning: Missing '{component} density [kg.m-3]'")
            
        for electrode in ["Negative electrode", "Positive electrode"]:
            stack_bd[f"{electrode} electrolyte density [mg.uL-1]"] = pava.get("Electrolyte density [kg.m-3]",0) / 1000
            stack_bd[f"{electrode} density [mg.uL-1]"] = pava.get(f"{electrode} density [kg.m-3]",0) / 1000
            stack_bd[f"{electrode} dry density [mg.uL-1]"] = (pava.get(f"{electrode} density [kg.m-3]",0)
            - pava.get(f"{electrode} porosity") * pava.get("Electrolyte density [kg.m-3]",0)) / 1000
            if stack_bd.get(f"{electrode} inactive material volume fraction") == 0:
                stack_bd[f"{electrode} inactive material density [mg.uL-1]"] = 0
                stack_bd[f"{electrode} active material density [mg.uL-1]"] = stack_bd[f"{electrode} dry density [mg.uL-1]"]
                warnings.warn(f"Warning: {electrode} inactive material volume fraction is 0, {electrode} inactive material density is set to 0")
            else:
                stack_bd[f"{electrode} inactive material density [mg.uL-1]"] = (
                    pava.get(f"{electrode} density [kg.m-3]",0) - 
                    pava.get(f"{electrode} porosity") * pava.get("Electrolyte density [kg.m-3]",0) - 
                    pava.get(f"{electrode} active material volume fraction",0) * 
                    pava.get(f"{electrode} active material density [kg.m-3]",0)
                ) / stack_bd.get(f"{electrode} inactive material volume fraction") / 1000
                stack_bd[f"{electrode} active material density [mg.uL-1]"] = pava.get(f"{electrode} active material density [kg.m-3]",0) / 1000
        stack_bd["Separator electrolyte density [mg.uL-1]"] = pava.get("Electrolyte density [kg.m-3]",0) / 1000
        stack_bd["Separator density [mg.uL-1]"] = pava.get("Separator density [kg.m-3]",0) / 1000
>>>>>>> Stashed changes
        if pava.get("Separator porosity") == 1:
            stack_bd["Separator material density [mg.uL-1]"] = 0
            warnings.warn("Warning: Separator porosity is 1, separator material density is set to 0")
        else:
<<<<<<< Updated upstream
...
=======
            stack_bd["Separator material density [mg.uL-1]"] = (pava.get("Separator density [kg.m-3]",0) - pava.get("Separator porosity") * pava.get("Electrolyte density [kg.m-3]",0)) / (1 - pava.get("Separator porosity")) / 1000
            stack_bd["Separator dry density [mg.uL-1]"] = (pava.get("Separator density [kg.m-3]",0) - pava.get("Separator porosity") * pava.get("Electrolyte density [kg.m-3]",0)) / 1000
...
=======
        components = ["Negative current collector",
                      "Negative current collector",
                      "Negative electrode active material",
                      "Negative electrode inactive material",
                      "Negative electrode electrolyte",
...
=======
        ...
        for component in components:
            compartment_heights.append(stack_bd.get(f"{component} mass loading [mg.cm-2]"))
            compartment_widths.append(stack_bd.get(f"{component} volume loading [uL.cm-2]"))
...
=======
        # Add the transparent rectangles to the plot
        for i, (h, w) in enumerate(zip(compartment_heights, compartment_widths)):
            rect = patches.Rectangle((x_pos, 0), w, h, linewidth=1, linestyle='dashed', edgecolor='black', facecolor='none')
>>>>>>> Stashed changes
            ax.add_patch(rect)
            x_pos += w
