...
class Tea(pybamm.BaseModel):
    ...
    def __init__(self, parameter_values=None):
        ...
        if self.parameter_values is None:
            print(
                "Warning: Missing parameter values, please supply parameter values to Tea()"
            )
        super().__init__()
    ...
    def stack_energy_densities(self, input_parameter=None, print_values=False):
        ...
        # areal capacity
        if (
            input_parameter is None
            or input_parameter.get("Capacity [mA.h.cm-2]", None) is None
        ):
            ...
            areal_capacity = sol[
                "Capacity [mA.h.cm-2]"
            ]  # mA.h.cm-2 or better min(sol[Q_n * (x_100 - x_0)], sol[Q_p * (y_0 - y_100)])?
        else:
        ...
        if input_parameter is None:
            ...
            ne_cc_thickness = self.parameter_values[
                "Negative current collector thickness [m]"
            ]
            pe_cc_thickness = self.parameter_values[
            ...
            try:
                ...
                sep_thickness = self.parameter_values["Separator thickness [m]"]
            try:
                ne_cc_thickness = input_parameter[
                    "Negative current collector thickness [m]"
                ]
            except KeyError:
                ne_cc_thickness = self.parameter_values[
            ...
            try:
                pe_cc_thickness = input_parameter[
                    "Positive current collector thickness [m]"
                ]
            except KeyError:
                pe_cc_thickness = self.parameter_values[
        ...
        try:
            stack_thickness = input_parameter[
                "Stack thickness [m]"
            ]  # better 'stack monolayer thickness'?
        except KeyError:
            stack_thickness = (
                ne_cc_thickness / 2
                + ne_thickness
        ...
        volumetric_stack_energy_density = (
            stack_average_ocv * areal_capacity / stack_thickness / 100
        )  # [Wh.L-1]

        # densities
        if input_parameter is None:
            ne_density = self.parameter_values[
                "Negative electrode density [kg.m-3]"
            ]  # density of dry electrode
            ...
            ne_cc_density = self.parameter_values[
                "Negative current collector density [kg.m-3]"
            ]
            pe_cc_density = self.parameter_values[
                "Positive current collector density [kg.m-3]"
            ]
            elyte_density = self.parameter_values[
                "Electrolyte density [kg.m-3]"
            ]  # density of electrolyte
            print(
                "Warning: Missing Electrolyte density, [1276 kg.m-3] has been used"
            )  # EC:EMC 1:1
        else:
            try:
                ...
                try:
                    ...
                    print(
                        "Error: Missing parameter value for negative electrode density"
                    )
            ...
            try:
                ...
                try:
                    pe_density = self.parameter_values[
                        "Positive electrode density [kg.m-3]"
                    ]
                except KeyError:
                    print(
                        "Error: Missing parameter value for positive electrode density"
                    )
            ...
            try:
                ...
                try:
                    ...
                    print(
                        "Error: Missing parameter value for negative current collector density"
                    )
                    ne_cc_density = float("-inf")
            try:
                pe_cc_density = input_parameter[
                    "Positive current collector density [kg.m-3]"
                ]
            except KeyError:
                try:
                    ...
                    print(
                        "Error: Missing parameter value for positive current collector density"
                    )
        ...
        if input_parameter is None:
            ...
            try:
                ...
                try:
                    ...
                    print(
                        "Error: Missing parameter value for negative electrode porosity"
                    )
            ...
            try:
                ...
                try:
                    ...
                    print(
                        "Error: Missing parameter value for positive electrode porosity"
                    )
        ...
        try:
            ne_composite_density = input_parameter[
                "Negative electrode composite density [kg.m-3]"
            ]
        except KeyError:
            ne_composite_density = ne_density / (1 - ne_porosity)
        try:
            pe_composite_density = input_parameter[
                "Positive electrode composite density [kg.m-3]"
            ]
        except KeyError:
            pe_composite_density = pe_density / (1 - pe_porosity)
        try:
            sep_composite_density = input_parameter[
                "Separator composite density [kg.m-3]"
            ]
        except KeyError:
        ...
        # weight fractions
        try:
            ne_composite_wt_fraction = input_parameter[
                "Negative electrode composite weight fraction"
            ]
            ne_elyte_wt_fraction = 1 - ne_composite_wt_fraction
        except KeyError:
            try:
                ne_elyte_wt_fraction = input_parameter[
                    "Negative electrode electrolyte weight fraction"
                ]
                ne_composite_wt_fraction = 1 - ne_elyte_wt_fraction
            except KeyError:
                ne_composite_wt_fraction = (
                    (1 - ne_porosity)
                    * ne_composite_density
                    / (
                        (1 - ne_porosity) * ne_composite_density
                        + ne_porosity * elyte_density
                    )
                )
                ne_elyte_wt_fraction = 1 - ne_composite_wt_fraction
        try:
            pe_composite_wt_fraction = input_parameter[
                "Positive electrode composite weight fraction"
            ]
            pe_elyte_wt_fraction = 1 - pe_composite_wt_fraction
        except KeyError:
            try:
                pe_elyte_wt_fraction = input_parameter[
                    "Positive electrode electrolyte weight fraction"
                ]
                pe_composite_wt_fraction = 1 - pe_elyte_wt_fraction
            except KeyError:
                pe_composite_wt_fraction = (
                    (1 - pe_porosity)
                    * pe_composite_density
                    / (
                        (1 - pe_porosity) * pe_composite_density
                        + pe_porosity * elyte_density
                    )
                )
                pe_elyte_wt_fraction = 1 - pe_composite_wt_fraction
        try:
            sep_composite_wt_fraction = input_parameter[
                "Separator composite weight fraction"
            ]
            sep_elyte_wt_fraction = 1 - sep_composite_wt_fraction
        except KeyError:
            try:
                sep_elyte_wt_fraction = input_parameter[
                    "Separator electrolyte weight fraction"
                ]
                sep_composite_wt_fraction = 1 - sep_elyte_wt_fraction
            except KeyError:
                sep_composite_wt_fraction = (
                    (1 - sep_porosity)
                    * sep_density
                    / ((1 - sep_porosity) * sep_density + sep_porosity * elyte_density)
                )
                sep_elyte_wt_fraction = 1 - sep_composite_wt_fraction

        # electrode and separator with electrolyte density
        try:
            ne_w_elyte_density = input_parameter[
                "Negative electrode with electrolyte density [kg.m-3]"
            ]
        except KeyError:
            ne_w_elyte_density = (
                ne_composite_density * ne_composite_wt_fraction
                + elyte_density * ne_elyte_wt_fraction
            )
        try:
            pe_w_elyte_density = input_parameter[
                "Positive electrode with electrolyte density [kg.m-3]"
            ]
        except KeyError:
            pe_w_elyte_density = (
                pe_composite_density * pe_composite_wt_fraction
                + elyte_density * pe_elyte_wt_fraction
            )
        try:
            sep_w_density = input_parameter[
                "Separator with electrolyte density [kg.m-3]"
            ]
        except KeyError:
            sep_w_elyte_density = (
                sep_composite_density * sep_composite_wt_fraction
                + elyte_density * sep_elyte_wt_fraction
            )

        # gravimetric stack energy density wh.kg-1
        try:
            stack_density = input_parameter[
                "Stack density [kg.m-3]"
            ]  # better 'stack mixed density'?
        except KeyError:
            stack_density = (
                ne_cc_thickness / 2 * ne_cc_density
                + ne_thickness * ne_w_elyte_density
                + sep_thickness * sep_w_elyte_density
                + pe_thickness * pe_w_elyte_density
                + pe_cc_thickness / 2 * pe_cc_thickness
            ) / stack_thickness  # [kg.m-3]

        gravimetric_stack_energy_density = (
            volumetric_stack_energy_density / stack_density * 1000
        )  # [Wh.kg-1]
        ...
        if print_values == True:
            ...
            print(
                "Negative electrode composite density [kg.m-3]: ", ne_composite_density
            )
            print(
                "Positive electrode composite density [kg.m-3]: ", pe_composite_density
            )
            ...
            print(
                "Negative electrode electrolyte weight fraction: ", ne_elyte_wt_fraction
            )
            print(
                "Positive electrode electrolyte weight fraction: ", pe_elyte_wt_fraction
            )
    ...
    def stack_breakdown(self, input_parameter=None, print_values=False):
        ...
        if input_parameter is None:
            ...
            # import densities
            try:
                aam_density = input_parameter[
                    "Anode active material true density [kg.m-3]"
                ]
            except KeyError:
                try:
                    aam_density = parameter_values[
                        "Anode active material true density [kg.m-3]"
                    ]
                except KeyError:
                    print("Error: Missing required AAM true density")
            try:
                electrolyte_density = input_parameter[
                    "Electrolyte true density [kg.m-3]"
                ]
            except KeyError:
                try:
                    electrolyte_density = parameter_values[
                        "Electrolyte true density [kg.m-3]"
                    ]
                except KeyError:
                    print("Error: Missing required electrolyte true density")
            try:
                cam_density = input_parameter[
                    "Cathode active material true density [kg.m-3]"
                ]
            except KeyError:
                try:
                    cam_density = parameter_values[
                        "Cathode active material true density [kg.m-3]"
                    ]
                except KeyError:
            ...
            try:
                ...
                try:
                    ne_cc_density = parameter_values[
                        "Negative current collector density [kg.m-3]"
                    ]
                except KeyError:
                    print(
            ...
            try:
                ...
                try:
                    pe_cc_density = parameter_values[
                        "Positive current collector density [kg.m-3]"
                    ]
                except KeyError:
                    print(
        ...
        ne_thickness = self.parameter_values["Negative electrode thickness [m]"]
        ne_aam_volume_fraction = self.parameter_values[
        ...
        composite_density = self.parameter_values[
            "Negative electrode composite density [kg.m-3]"
        ]
...
lfp_input_data = {
    "Negative current collector thickness [m]": 0.00001,  # example
...
energy_densities_NMC = nmc.stack_energy_densities(
    input_parameter=nmc_input_data, print_values=True
)
print("Prada2013")
energy_densities_LFP = lfp.stack_energy_densities(
    input_parameter=lfp_input_data, print_values=True
)
